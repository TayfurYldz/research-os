...
| — (epistemic hardening, same-generation fix) | Slice 6 | DONE this campaign (see `SLICE_6_COMPLETION_RECORD.md`; ImpactGraph edges require resolvable `proof_refs`; caller severity cannot exceed demonstrated impact) |
