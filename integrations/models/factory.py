...
from integrations.models.common import JsonSchemaModelAdapter
from integrations.models.secrets import (
...
def _transport(adapter_id: str, *, model_id: str, secret: SecretReference, env: dict[str, str]):
    ...
    if adapter_id == "anthropic":
        from integrations.models.anthropic_adapter import AnthropicMessagesTransport

        return AnthropicMessagesTransport(model_id=model_id, secret=secret, env=env)
    from integrations.models.gemini_adapter import GeminiGenerateContentTransport
