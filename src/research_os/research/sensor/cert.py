"""Certificate metadata sensor.

This gate uses already-collected passive data (e.g., from CT log or DNS TLSA);
active TLS handshake is not performed here.
"""
...
class CertificateMetaSensor:
    """Passive certificate metadata sensor."""

    sensor_id = "sensor.cert"
