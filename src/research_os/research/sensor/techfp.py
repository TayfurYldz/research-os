...
This gate fingerprints only from already-collected passive data (headers, HTML
meta, JS paths). Active banner grab is not performed here.
"""
...
class TechnologyFingerprintSensor:
    """Passive technology fingerprint sensor."""

    sensor_id = "sensor.techfp"
